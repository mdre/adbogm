...
import net.adbogm.utils.AgentDetector;
...
//                    .addDetector("net.adbogm.annotations.Entity")
//                    //.addIgnore("net.adbogm")
//                    //.addIgnore("org.gradle")
//                    ;
//            
//        } catch (TDDAgentInitializationException ex) {
//            LOGGER.log(Level.SEVERE, "Agent Initialization Error!!",ex);
//        }
    ...
    private SessionManager setActivationStrategy(ActivationStrategy as, boolean loadAgent) {
        ...
        LOGGER.log(Level.DEBUG, "ActivationStrategy using {}", as);
    ...
    public void loadAgent() {
        LOGGER.log(Level.INFO, "initializing tdd-agent...");
        TransparentDirtyDetectorAgent.initialize();
//        TransparentDirtyDetectorAgent.get().addDetector("net.adbogm.annotations.Entity") ;
        TransparentDirtyDetectorAgent.get().enableDumpDebugDirectory("/tmp/1/asm") ;
    }
...
//     */
     ...
     */
    // FIXME: verificar urgente como se implementaría esto. 
     ...
     * @return Type o null si la clase no existe
     */
    public DocumentType getDBClass(String clase) {
        return this.publicTransaction.getDBType(clase);
    }
