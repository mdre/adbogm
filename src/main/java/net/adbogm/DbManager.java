...
public class DbManager {
    ...
    * @param serverName  URL.
     ...
     */
    @Deprecated
    public DbManager(String serverName, int port, String database, String user, String passwd) {
        this.init(serverName, port, database, user, passwd);
    }
     ...
     */
    @Deprecated
    public DbManager(String serverName, int port, String database, String user, String passwd, boolean withDrops) {
        this.init(serverName, port, database, user, passwd);
        this.withDrops = withDrops;
    }


    private void init(String serverName, int port, String database, String user, String passwd) {
        LOGGER.log(Level.INFO, "ADBOGM Session Manager initialization...");
        this.arcadeDB = new RemoteDatabase(serverName, port, database, user, passwd);
...
//    }
    ...
    public void generateDBSQL(String fileName, String[] analize){
        ...
        PrintWriter pw = null;
        try {
            LOGGER.log(Level.DEBUG, "abriendo el archivo...");
            fw = new FileWriter(fileName);
            LOGGER.log(Level.DEBUG, "preparando el printwriter...");
            pw = new PrintWriter(fw);
            LOGGER.log(Level.DEBUG, "procesando {} lineas...", orderedRegisteredClass.size());
            for (ClassStruct orderedRegisteredClas : orderedRegisteredClass) {
    ...
    private ClassStruct buildDBScript(Class clazz) {
        ...
        LOGGER.log(Level.DEBUG, "procesando: {}...", clazz.getSimpleName());
    ...
    //                    String linkedType() default "";
                    ...
                    // Ej. UserSID / GroupSID
                    LOGGER.log(Level.DEBUG, "field type: {}", field.getType());
    ...
    private boolean isEdgeType(Class<?> c) {
